...
// Manipulation.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CManipulationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CManipulationApp

CManipulationApp::CManipulationApp()
{
...
// Единственный объект CManipulationApp

CManipulationApp theApp;


// инициализация CManipulationApp

BOOL CManipulationApp::InitInstance()
{
